...
public class Shooter extends Subsystem implements IVelocityControlledSubsystem {
	...
	private final SRXGains shooterGains = new SRXGains(Shooter_PIDX, 0.1, 0, 0, .05, 100);//0.2, 0, 0, 0.05, 100
	...
	private MotionParameters shooterMotionParameters = new MotionParameters(11000, 5500, shooterGains);// velocity could be up to 21k
