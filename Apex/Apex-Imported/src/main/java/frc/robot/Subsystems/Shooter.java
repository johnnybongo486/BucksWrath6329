...
public class Shooter extends Subsystem implements IVelocityControlledSubsystem {
	...
	private final SRXGains shooterGains = new SRXGains(Shooter_PIDX, 0.2, 0, 0, .05, 100);//0.2, 0, 0, 0.05, 100
	private final SRXGains slowShooterGains = new SRXGains(Shooter_PIDX, 0.1, 0, 0, 0, 100);//0.2, 0, 0, 0.05, 100

	
	//Uses PID values to go to a Velocity
	private MotionParameters shooterMotionParameters = new MotionParameters(11000, 5500, shooterGains);// 4700
	private MotionParameters slowShooterMotionParameters = new MotionParameters(11000, 5500, slowShooterGains);// 4700

	
	private double peakOutputForward = 1.0;
	private double peakOutputReverse = -1.0;

	public CustomTalonFX ShooterFalcon = new CustomTalonFX(0);
	private CustomTalonFX ShooterFollower = new CustomTalonFX(1);
	...
	public Shooter() {
		...
		this.ShooterFalcon.setInverted(false);
		...
		this.ShooterFalcon.configClosedloopRamp(0.5);
