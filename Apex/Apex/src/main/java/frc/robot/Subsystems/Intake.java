...
public class Intake extends Subsystem{
    public TalonSRX IntakeESC = new TalonSRX(2);

    public Intake() {
        IntakeESC.setInverted(false);
    ...
    public void runIntake() {
        IntakeESC.set(ControlMode.PercentOutput, 0.9);
    }

    public void reverseIntake() {
        IntakeESC.set(ControlMode.PercentOutput, -0.6);
    }
