...
public class CustomTalonFX extends TalonFX {
    ...
    public void setCurrentLimit(StatorCurrentLimitConfiguration statorCurrentLimit, SupplyCurrentLimitConfiguration supplyCurrentLimit){
        super.configSupplyCurrentLimit(supplyCurrentLimit, 10);
        super.configStatorCurrentLimit(statorCurrentLimit, 10);
    }
}
