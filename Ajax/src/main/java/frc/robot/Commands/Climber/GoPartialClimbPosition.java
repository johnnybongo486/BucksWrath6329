...
public class GoPartialClimbPosition extends CommandBase {
	...
	public void initialize() {
		RobotContainer.leftClimber.setTargetPosition(26000);
		RobotContainer.rightClimber.setTargetPosition(26000);
	}
