...
public class CustomCANCoder {
   ...
   * @param invert Whether to invert the encoder or not
   */
  public CustomCANCoder(int id, String canivore, boolean invert) {
    this.inverted = invert;
