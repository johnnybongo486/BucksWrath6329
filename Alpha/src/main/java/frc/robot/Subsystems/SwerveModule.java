...
import frc.lib.motion.CustomCANCoder;
...
public class SwerveModule {
  ...
  private CustomCANCoder angleEncoder;
  ...
  public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
    ...
    angleEncoder =
        new CustomCANCoder(moduleConstants.cancoderID, Constants.SwerveConstants.canCoderInvert);
