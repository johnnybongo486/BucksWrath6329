...
public class Swerve extends SubsystemBase {
  ...
  private final DoubleEntry gyroYaw;
  private final Pose2dEntry odometryPose;
  ...
  public Swerve() {
    ...
    gyroYaw = new DoubleEntry("/Diagnostics/Swerve/Gyro/Yaw", 0.0, true);
    odometryPose = new Pose2dEntry("/Diagnostics/Swerve/Odometry", new Pose2d(), true);
  }
