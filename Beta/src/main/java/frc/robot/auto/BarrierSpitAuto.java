...
public class BarrierSpitAuto extends SequentialCommandGroup {
    ...
    public BarrierSpitAuto(Swerve s_Swerve){
        ...
        PathPlannerTrajectory path2 = PathPlanner.loadPath("BarrierSpit1", 4.0, 3.0);
        PathPlannerTrajectory path3 = PathPlanner.loadPath("BarrierGrab2", 4.0, 3.0);
        PathPlannerTrajectory path4 = PathPlanner.loadPath("BarrierSpit2", 4.0, 3.0);
        PathPlannerTrajectory path5 = PathPlanner.loadPath("BarrierReady", 4.0, 3.0);
        ...
        addCommands(
            ...
            s_Swerve.followTrajectoryCommand(path2, false).alongWith(new StoreObjectCommandGroup().withTimeout(1.5).andThen(new SpitCube().withTimeout(0.75))),
            s_Swerve.followTrajectoryCommand(path3, false).alongWith(new FloorIntakeCommandGroup().withTimeout(2)),
            s_Swerve.followTrajectoryCommand(path4, false).alongWith(new StoreObjectCommandGroup().withTimeout(1.5).andThen(new SpitCube().withTimeout(0.75))),
            s_Swerve.followTrajectoryCommand(path5, false),
