...
public class BarrierSpitAuto extends SequentialCommandGroup {
    ...
    public BarrierSpitAuto(Swerve s_Swerve){
        ...
        PathPlannerTrajectory path5 = PathPlanner.loadPath("BarrierReady", 4.0, 4.0);
        ...
        addCommands(
            ...
            s_Swerve.followTrajectoryCommand(path1, true).alongWith(new AutoHomeStateCommandGroup().andThen(new FloorIntakeCommandGroup().withTimeout(2.25))),
