...
public class Blue2ConeAuto extends SequentialCommandGroup {
    private double i2m = 0.0254;

    public Blue2ConeAuto(Swerve s_Swerve){
        ...
        addCommands(
            new AutoZero(s_Swerve).withTimeout(0.001),
            new InstantCommand(() -> s_Swerve.resetOdometry(GrabBlueCone1.getInitialPose())),
            swerveControllerCommand,
            new InstantCommand(() -> s_Swerve.resetOdometry(ReturnBlueCone1.getInitialPose())),
