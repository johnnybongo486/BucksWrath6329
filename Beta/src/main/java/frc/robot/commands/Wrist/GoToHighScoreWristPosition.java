...
public class GoToHighScoreWristPosition extends CommandBase {
	
	private int desiredPosition;
	private int conePosition = RobotContainer.wrist.getHighScorePosition();
	private int cubePosition = RobotContainer.wrist.getHomePosition();
	private boolean isCone;

	public GoToHighScoreWristPosition() {
