...
public class RobotContainer {
    ...
    private final JoystickButton balanceButton = new JoystickButton(operator, XboxController.Button.kStart.value);
    ...
    /* Subsystems */
    private final Swerve swerve = new Swerve(); // was private final
    ...
    private void configureButtonBindings() {
        ...
        balanceButton.whileTrue(new AutoBalance(swerve));
    }
    ...
    public Command getAutonomousCommand() {
        ...
        //return new DriveOneMeter(swerve);
    }
}
